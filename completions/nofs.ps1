...
Register-ArgumentCompleter -Native -CommandName 'nofs' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        ...
        'nofs;cp' {
            ...
            [CompletionResult]::new('--min-size', '--min-size', [CompletionResultType]::ParameterName, 'Minimum file size to include (e.g., 5M, 1G)')
            [CompletionResult]::new('--max-size', '--max-size', [CompletionResultType]::ParameterName, 'Maximum file size to include (e.g., 10M, 2G)')
