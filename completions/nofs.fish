...
complete -c nofs -n "__fish_nofs_using_subcommand ls" -s l -l long -d 'Show detailed information'
complete -c nofs -n "__fish_nofs_using_subcommand ls" -s a -l all -d 'Show hidden files'
...
complete -c nofs -n "__fish_nofs_using_subcommand find" -l name -d 'Filename pattern (glob)' -r
complete -c nofs -n "__fish_nofs_using_subcommand find" -l type -d 'File type: f=file, d=directory' -r
complete -c nofs -n "__fish_nofs_using_subcommand find" -l maxdepth -d 'Maximum depth' -r
...
complete -c nofs -n "__fish_nofs_using_subcommand which" -s a -l all -d 'Show all branches containing the file'
...
complete -c nofs -n "__fish_nofs_using_subcommand stat" -s H -l human -d 'Show human-readable sizes'
...
complete -c nofs -n "__fish_nofs_using_subcommand cp" -l file-over-file -d 'File-over-file conflict strategy (e.g., "skip-hash rename-dest")' -r
complete -c nofs -n "__fish_nofs_using_subcommand cp" -l file-over-folder -d 'File-over-folder conflict strategy' -r
complete -c nofs -n "__fish_nofs_using_subcommand cp" -l folder-over-file -d 'Folder-over-file conflict strategy' -r
...
complete -c nofs -n "__fish_nofs_using_subcommand cp" -s E -l exclude -d 'Exclude patterns (glob)' -r
complete -c nofs -n "__fish_nofs_using_subcommand cp" -s I -l include -d 'Include patterns (glob)' -r
...
complete -c nofs -n "__fish_nofs_using_subcommand cp" -s h -l help -d 'Print help'
complete -c nofs -n "__fish_nofs_using_subcommand cp" -s V -l version -d 'Print version'
complete -c nofs -n "__fish_nofs_using_subcommand mv" -l file-over-file -d 'File-over-file conflict strategy (e.g., "skip-hash rename-dest")' -r
complete -c nofs -n "__fish_nofs_using_subcommand mv" -l file-over-folder -d 'File-over-folder conflict strategy' -r
complete -c nofs -n "__fish_nofs_using_subcommand mv" -l folder-over-file -d 'Folder-over-file conflict strategy' -r
...
complete -c nofs -n "__fish_nofs_using_subcommand mv" -s E -l exclude -d 'Exclude patterns (glob)' -r
complete -c nofs -n "__fish_nofs_using_subcommand mv" -s I -l include -d 'Include patterns (glob)' -r
complete -c nofs -n "__fish_nofs_using_subcommand mv" -s S -l size -d 'Filter by file size (e.g., +5M, -10M)' -r
complete -c nofs -n "__fish_nofs_using_subcommand mv" -s l -l limit -d 'Limit number of files transferred' -r
complete -c nofs -n "__fish_nofs_using_subcommand mv" -l size-limit -d 'Limit total size transferred (e.g., 100M, 1G)' -r
...
complete -c nofs -n "__fish_nofs_using_subcommand mv" -s h -l help -d 'Print help'
...
complete -c nofs -n "__fish_nofs_using_subcommand rm" -s v -l verbose -d 'Verbose output'
...
complete -c nofs -n "__fish_nofs_using_subcommand mkdir" -s v -l verbose -d 'Verbose output'
...
complete -c nofs -n "__fish_nofs_using_subcommand rmdir" -s v -l verbose -d 'Verbose output'
...
complete -c nofs -n "__fish_nofs_using_subcommand touch" -s v -l verbose -d 'Verbose output'
...
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "ls" -d 'List directory contents (like ls)'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "find" -d 'Find files matching a pattern'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "which" -d 'Find which branch contains a file'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "create" -d 'Get the best branch path for creating a new file'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "stat" -d 'Show filesystem statistics'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "info" -d 'Show share configuration and status'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "exists" -d 'Check if a file exists and return its location'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "cat" -d 'Read file content (from first found branch)'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "cp" -d 'Copy files/directories (supports nofs context paths)'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "mv" -d 'Move files/directories (supports nofs context paths)'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "rm" -d 'Remove files or directories'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "mkdir" -d 'Create directories'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "rmdir" -d 'Remove empty directories'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "touch" -d 'Create or update files'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "completions" -d 'Generate shell completion scripts'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "manpage" -d 'Generate man page'
complete -c nofs -n "__fish_nofs_using_subcommand help; and not __fish_seen_subcommand_from ls find which create stat info exists cat cp mv rm mkdir rmdir touch completions manpage help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
